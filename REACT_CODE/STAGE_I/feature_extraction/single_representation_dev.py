...
def main():
    ...
    save_dir = os.path.join(args.output_path, f"dev_{chunk_name}")
    ...
    for idx, batch in enumerate(tqdm(dataloader)):
        ...
        cls_repr = last_hidden_state.mean(dim=1).cpu()
    ...
    if all_reps:
        ...
        torch.save(all_reps_tensor, os.path.join(save_dir, "reps-all.pt"))
        print(f"Saved all representations to {save_dir}/reps-all.pt | Shape: {all_reps_tensor.shape}")
